    ...
    <header class="header1">
        <div class="header-top d-none d-md-block">
            ...
            <header class="header1">
                ...
                ?>
                    <li><a href="trangadmin/admin/index.php?act=listtk" style="color:black"> <?= $user ?></a> --- <a href="index.php?act=thoat" style="color:black">Logout</a></li>
                    <!-- <li></li> -->
                    <li><a href="index.php?act=mybill" class="text-btn">Chi tiết đơn hàng</a></li>
                <?php
                } else {
                ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="checkout-form-list">
                        <label style="font-size:50px;">Code Order</label>
                        <li>MA-<?= $bill['id'] ?></li>
