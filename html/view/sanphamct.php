                     ...
                     <div class="product-side-info mb-30">
                        ...
                        <div class="product-quantity-cart mb-25">
                           <div class="product-quantity-form">
                              ...
                              <input class="cart-input" type="text" name="quantity" value="0" id="quantity" required>
                           ...
                           <div class="comment-input-box mb-20">
                              ...
                              <div class="row">
                                 <div class="col-xxl-12">
                                    ...
                                    <!-- <input class="comment-input comment-textarea mb-20" type="text" name="msg"> -->
                                    <style>
                                       .bang {
                                          width: 100%;
